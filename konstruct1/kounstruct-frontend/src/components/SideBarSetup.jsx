...
function SideBarSetup() {
  ...
  // --- Add "Create Purpose" only for Super Admin ---
  if (badgeRole.toLowerCase() === "super admin") {
    navItems.splice(1, 0, { name: "Purpose Management", path: "/create-purpose" }); // add after User Setup
  }
